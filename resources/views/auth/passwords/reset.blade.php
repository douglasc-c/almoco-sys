...
@section('content')
    {{-- <h4 class="text-center mb-4">Senha</h4> --}}
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-lg-12 auth-bloc">
                                            <label class="auth-label-bloc">
                                                ...
                                                <input type="text" class="auth-form-control @error('password') is-invalid @enderror"  placeholder="Senha" name="password" class="input-bordered">
                                            </label>
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-lg-12 auth-bloc">
                                            <label class="auth-label-bloc">
                                                <i class="fas fa-lock auth-label-icon"></i>
                                                <input type="text" class="auth-form-control @error('password_confirmation') is-invalid @enderror"  placeholder="Confirme sua senha" name="password_confirmation" class="input-bordered">
                                            </label>
