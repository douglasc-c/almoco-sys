				...
				<div class="right-topbar ml-auto">
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown dropdown-user-profile">
							...
							<div class="dropdown-menu dropdown-menu-right">	<a class="dropdown-item" href="{{URL::action('Dashboard\HomeController@index')}}"><i
										class="bx bx-user"></i><span>Profile</span></a>
								<a class="dropdown-item" href="{{URL::action('Dashboard\ProfileController@index')}}"><i
